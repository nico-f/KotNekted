...
use DotNet\TaskListBundle\Entity\Task;
use DotNet\TaskListBundle\Form\TaskType;
...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DotNetTaskListBundle:Task')->findAll();
     ...
     * @Method("POST")
     * @Template("DotNetTaskListBundle:Task:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DotNetTaskListBundle:Task')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DotNetTaskListBundle:Task:edit.html.twig")
     */
